...
- **Lo que ya vigila una comprobación**: `eslint`, `oxlint`, `prettier`, `tsc`, las 84 pruebas de backend, las 28 de frontend, `openapi:check` y las 18 comprobaciones de `verificar-docs.mjs`. Si un script ya lo muerde, un modelo mirándolo es gasto.
