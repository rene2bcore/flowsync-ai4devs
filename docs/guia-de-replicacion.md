...
npm test        # 83 pruebas functional
```
...
Lo que tiene que salir hoy en la rama del port: **83 pruebas de backend, 28 de frontend, 18 comprobaciones del verificador, y cuatro ceros.**
